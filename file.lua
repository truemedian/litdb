--------------------------------------------------------------------------------
-- Library for binding to zlib for compression and decompression. See
-- the github for examples and usage.
--
-- Copyright (C) 2016 Hamish Forbes. All rights reserved.
--
-- Features, documentation and more: https://zlib.net.
--
-- This library is originally released on github under the MIT license: see
-- LICENSE.txt in the github root folder. https://github.com/hamishforbes/lua-ffi-zlib
--------------------------------------------------------------------------------
--[[lit-meta
  name = "PatrickDahlin/ffi-zlib"
  version = "1.0.0"
  homepage = "https://github.com/hamishforbes/lua-ffi-zlib"
  description = "ffi-zlib bindings repackaged for lit."
  tags = {"compress", "zlib", "ffi"}
  license = "MIT"
