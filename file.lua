--[[lit-meta
	name = 'TohruMKDM/class'
	version = '1.0.0'
	homepage = 'https://github.com/SinisterRectus/Discordia/blob/master/libs/class.lua'
	description = "A distribution of discordia's class system which allows it to be listed as a dependency in separate projects."
	tags = {'class', 'classes'}
	license = 'MIT'
